...
| **[VIRTUAL_CHANNEL_ROUTING_ADR.md](./VIRTUAL_CHANNEL_ROUTING_ADR.md)** | Normative virtual buckets (`announcements` / `monitor` / `polls`): rumor tag + JSON field + derivation (single-group refactor) |
